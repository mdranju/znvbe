...
function AddressForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className="block text-xs font-bold text-gray-500 mb-1.5">
          Apartment / Suite <span className="font-normal">(optional)</span>
        </label>
        <input
      ...
      <label className="flex items-center gap-3 cursor-pointer group">
        ...
        >
          <div
            className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full shadow transition-transform ${form.isDefault ? "translate-x-5" : ""}`}
          />
        </div>
